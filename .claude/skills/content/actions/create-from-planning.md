...
3. **KB source existe** : verifier que `_meta/modules/{module}/savoir.md` et `_meta/modules/{module}/praxeologies.md` existent (consulter `_meta/_interface.yaml` pour resoudre les references module)
