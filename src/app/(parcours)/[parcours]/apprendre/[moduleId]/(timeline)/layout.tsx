/**
 * Timeline Layout (Split View)
 *
 * Provides split view structure for activity pages only.
 * Desktop: sidebar with timeline + content area
 * Mobile: collapsible sidebar overlay
 *
 * Wrapped in route group (timeline) so that the module page
 * is NOT inside the split view.
 */
...
export default async function TimelineLayout({ children, params }: LayoutProps) {
